...
# export your email to your env as "BOT_EMAIL"
# export your email password to your env as "BOT_EMAIL_PASSWORD"

# ENTER YOUR KIWI API KEY:
# export your KIWI API Key to your env as "KIWI_API_KEY"
