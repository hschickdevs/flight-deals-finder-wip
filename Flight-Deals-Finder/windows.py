...
class MainMenu(Tk):
    def __init__(self, search_func):
        ...
        self.departure_city_entry.grid(row=1, column=0, pady=2.5, columnspan=2)
        self.arrival_city_entry = PlaceholderEntry(self, "Arrival City...")
        self.arrival_city_entry.grid(row=2, column=0, pady=2.5, columnspan=2)
        self.from_date_entry = PlaceholderEntry(self, "From (dd/mm/yyyy)...")
        self.from_date_entry.grid(row=3, column=0, pady=2.5, columnspan=2)
        self.to_date_entry = PlaceholderEntry(self, "To (dd/mm/yyyy)...")
        self.to_date_entry.grid(row=4, column=0, pady=2.5, columnspan=2)
        ...
        self.nights_in_dest_entry.grid(row=5, column=0, pady=2.5, columnspan=2)
        ...
        self.emails_checkbutton = Checkbutton(text="Receive Email Alert", variable=self.emails_on)
        self.emails_checkbutton.grid(row=11, column=0, columnspan=2, pady=2.5)
        self.layovers_on = IntVar()
        self.layovers_checkbutton = Checkbutton(text="Layovers", variable=self.layovers_on)
